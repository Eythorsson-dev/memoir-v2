...
export type BlockCreatedEventDto     = { id: BlockId; data: Text; previousBlockId: BlockId | null; parentBlockId: BlockId | null }
export type BlockDataUpdatedEventDto = { id: BlockId; data: Text }
